...
if (isset($_GET['smazat'])) {
    $id = $_GET['smazat'];
    $pdo->prepare("DELETE FROM hry WHERE id = ?")->execute([$id]);
}

$free = $pdo->query("SELECT * FROM hry WHERE stav = 'dostupná'")->fetchAll();
$not = $pdo->query("SELECT * FROM hry WHERE stav = 'nedostupná'")->fetchAll();
$taken = $pdo->query("SELECT * FROM hry WHERE stav = 'vypůjčená'")->fetchAll();
?>
<!DOCTYPE html>
<html>
<head>
